...
export default function DeptAdminDashboard() {
  const { user } = useAuth();
  const { projects, applications, updateProject, deleteProject } = useData();
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <span className="px-3 py-1 bg-white/20 rounded-full text-sm font-medium">Administrator</span>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
          ...
          <div className="space-y-3">
            <button
              onClick={() => router.push('/dept-admin/projects')}
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">{`${pendingApprovals.length} project${pendingApprovals.length === 1 ? '' : 's'} pending approval`}</div>
                </div>
              </div>
            ...
            <button
              onClick={() => router.push('/dept-admin/students')}
            ...
            <button
              onClick={() => router.push('/dept-admin/analytics')}
            ...
            <button
              onClick={() => router.push('/dept-admin/faculty')}
              className="w-full flex items-center justify-between p-4 bg-pink-50 hover:bg-pink-100 rounded-lg transition-colors text-left"
            >
              <div className="flex items-center">
                <UserPlus className="w-5 h-5 text-pink-600 mr-3" />
                <div>
                  <div className="font-medium text-gray-900">Faculty Management</div>
                  <div className="text-sm text-gray-500">Assign roles & manage faculty</div>
                </div>
              </div>
            ...
            {recentProjects.map((project) => (
              <div key={project.id} className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-xs text-gray-500">by {project.facultyName}</div>
                </div>
              </div>
            ))}
          </div>
