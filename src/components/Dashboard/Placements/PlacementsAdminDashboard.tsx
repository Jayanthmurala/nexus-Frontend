        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
          ...
          <div className="space-y-3">
            <button
              ...
              onClick={() => router.push(ROUTES.PLACEMENTS_ADMIN.students)}
            >
            ...
            <button
              ...
              onClick={() => router.push(`${ROUTES.PLACEMENTS_ADMIN.students}?export=1`)}
            >
              <div className="flex items-center">
            ...
            <button
              ...
              onClick={() => router.push(ROUTES.PLACEMENTS_ADMIN.events)}
            >
              <div className="flex items-center">
            ...
            <button
              ...
              onClick={() => router.push(ROUTES.PLACEMENTS_ADMIN.analytics)}
            >
              <div className="flex items-center">
