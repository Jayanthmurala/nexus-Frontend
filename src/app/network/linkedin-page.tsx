...
import { networkApi, NetworkStats, User, DirectoryResponse } from '../../lib/networkApi';
import toast from 'react-hot-toast';

export default function LinkedInNetworkPage() {
  ...
  const fetchUsers = useCallback(async () => {
    setLoading(true);
    try {
      const response = await networkApi.getUserDirectory(20, 0);
  ...
  }, [user, fetchNetworkStats, fetchUsers, fetchConnections, fetchSuggestions]);
